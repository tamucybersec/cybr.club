// TODO - make the scripts ts and make them inside components (using islands)

import { officers, alumni } from "./members";
...
$(document).on("click", 'a[href^="#"]', function (event) {
	//when link with "#" clicked
	event.preventDefault(); //prevent default click event
	$("html, body").animate(
		{
			//animate window scrolling (on click of "#" link)
			scrollTop: $($.attr(this, "href")).offset().top, //when scrolling to link destination
		},
		1000
	); //at animated window speed of 1000ms
});
