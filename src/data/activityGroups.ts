...
export const activityGroups: ActivityGroup[] = [
	...
	},
	{
		...
		modalContent:
			"These meetings are designed to give you a solid introduction to cybersecurity in a relaxed and supportive setting. You'll pick up essential skills, see real-time demonstrations, get insights directly from people working in the field, and grow your cybersecurity network. Whether you're just getting curious or ready to take your first steps, this group makes it easy to jump in and start learning.",
		day: "Wednesday",
		time: "7:00",
	...
	},
	{
		...
		modalContent:
			"This group dives into the key concepts and technologies from Palo Alto Networks. You'll build practical skills through real-world scenarios and prepare for certifications that can give you a head start in internships or jobs. Whether you're just getting started or want to sharpen your expertise, this group helps you stand out to employers.",
		day: "Thursday",
		time: "7:00",
	...
	},
	{
		...
		modalContent:
			"Cisco is a global leader in networking technology, and this group offers you a chance to learn core principles that power the internet and enterprise networks. You'll progress through focused lessons and monthly labs that develop your ability to configure routers, switches, and more. Whether you're aiming for the CCNA certification or just want solid networking skills, this group prepares you for success in virtually any tech career.",
		day: "Thursday",
		time: "8:00",
